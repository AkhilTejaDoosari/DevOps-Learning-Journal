...
- [2. The Permission Model: Owner, Group, Others](#2-the-permission-model-owner-group-others)
- [3. Read, Write, Execute Explained](#3-read-write-execute-explained)
- [4. Permission Calculation: Octal and Symbolic](#4-permission-calculation-octal-and-symbolic)
- [5. chmod: Changing Permissions](#5-chmod-changing-permissions)
- [6. chown: Changing Ownership](#6-chown-changing-ownership)
- [7. Interpreting ls -l Output](#7-interpreting-ls--l-output)
- [8. Common Permission Patterns](#8-common-permission-patterns)
- [9. Special Permissions: SUID](#9-special-permissions-suid)
- [10. Special Permissions: SGID](#10-special-permissions-sgid)
- [11. Special Permissions: Sticky Bit](#11-special-permissions-sticky-bit)
- [12. umask: Default Permissions](#12-umask-default-permissions)
- [13. ACLs: Fine-Grained Control](#13-acls-fine-grained-control)
...
### PERM-001 — Three Permission Layers
...
<details>
<summary><strong>3. Read, Write, Execute Explained</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-003 — For Regular Files
...
<details>
<summary><strong>4. Permission Calculation: Octal and Symbolic</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-005 — Octal Values

| Octal | Symbolic | Binary | Calculation      | Meaning               |
|:-----:|:--------:|:------:|------------------|-----------------------|
| 0     | `---`    | 000    | 0                | none                  |
| 1     | `--x`    | 001    | 2⁰ = 1           | execute only          |
| 2     | `-w-`    | 010    | 2¹ = 2           | write only            |
| 3     | `-wx`    | 011    | 2¹+2⁰ = 3        | write+execute         |
| 4     | `r--`    | 100    | 2² = 4           | read only             |
| 5     | `r-x`    | 101    | 2²+2⁰ = 5        | read+execute          |
| 6     | `rw-`    | 110    | 2²+2¹ = 6        | read+write            |
| 7     | `rwx`    | 111    | 2²+2¹+2⁰ = 7     | read+write+execute    |
...
<details>
<summary><strong>5. chmod: Changing Permissions</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-006 — Symbolic Mode
...
<details>
<summary><strong>6. chown: Changing Ownership</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-008 — chown Command
...
<details>
<summary><strong>7. Interpreting ls -l Output</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-009 — Reading ls -l
...
<details>
<summary><strong>8. Common Permission Patterns</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-010 — File Patterns
...
<details>
<summary><strong>9. Special Permissions: SUID</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-012 — SUID Explained
...
<details>
<summary><strong>10. Special Permissions: SGID</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-013 — SGID Explained
...
# Output: drwxrwsr-x ... developers (note 's' in group position)
```
...
<details>
<summary><strong>11. Special Permissions: Sticky Bit</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-014 — Sticky Bit Explained
...
### PERM-015 — Special Permission Summary
...
<details>
<summary><strong>12. umask: Default Permissions</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-016 — umask Explained
...
<details>
<summary><strong>13. ACLs: Fine-Grained Control</strong></summary>

<div style="margin-left: 16px; margin-right: 16px; margin-top: 8px; margin-bottom: 8px;">

### PERM-017 — ACLs Explained
...
```bash copy
chmod u=rw file   # set exact permissions for owner
```
...
| `x` (execute) | Run file as program/script | Enter directory (`cd`) |

**Special Permissions:**

| Bit | Numeric | Symbol | Effect |
|-----|---------|--------|--------|
| SUID | 4xxx | `s` in user x position | Executable runs as file owner |
| SGID | 2xxx | `s` in group x position | Dir: new items inherit dir's group; Exec: runs as group |
| Sticky | 1xxx | `t` in other x position | Dir: only owner/root can delete files inside |
...
| `chmod 755 script` | `rwxr-xr-x` | Owner full, others read/execute |
| `chmod 600 secret` | `rw-------` | Owner only |
| `chmod u+x file` | Add execute for owner | Symbolic mode |
| `chmod g-w file` | Remove write from group | Symbolic mode |
| `chmod 4755 file` | SUID + `rwxr-xr-x` | Special permission |
