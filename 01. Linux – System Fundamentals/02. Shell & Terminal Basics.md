...
- [2. The Confusion Most People Have](#2-the-confusion-most-people-have)
- [3. Shell vs Terminal: Inside-Out](#3-shell-vs-terminal-inside-out)
...
<details>
<summary><strong>2. The Confusion Most People Have</strong></summary>
...
<details>
<summary><strong>3. Shell vs Terminal: Inside-Out</strong></summary>
...
### SHL-001 — What is a Shell?

A shell is a program that:
- Reads commands from you
- Interprets them
- Executes them
- Returns results
...
### SHL-002 — PATH Environment Variable
...
### SHL-006 — Command Execution Flow
...
### SHL-007 — Terminal Essentials (Old Content Reused)
...
### SHL-008 — Interactive vs Non-Interactive Shells
...
### SHL-010 — Getting Help (Old Content Reused)
...
```bash copy
type ls   # show what 'ls' resolves to (alias, builtin, or binary)
```
